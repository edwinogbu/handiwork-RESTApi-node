...
//         // Prepare update query based on changed fields (excluding imagePath)
//         const updateFields = Object.entries(updatedFields).filter(([key, value]) => value !== currentProvider[key] && key !== 'imagePath');
//         const updateValues = updateFields.map(([key, value]) => `${key}=?`).join(', ');
//         const updateParams = updateFields.map(([key, value]) => value);
...
//             WHERE id=?
//         `;
//         await query(updateQuery, [...updateParams, updatedAddress]);

//         // Return updated skill provider data (excluding imagePath)
//         const updatedProviderData = updateFields.reduce((acc, [key, value]) => {
//             acc[key] = value;
//             return acc;
...
//         // Add providerId at the end of updateParams
//         const updateParams = updateFields.map(([key, value]) => value);
//         updateParams.push(updatedAddress, providerId);
...
//             // Only add fields to update if they exist and are different from current values
//             if (currentProvider[key] !== undefined && currentProvider[key] !== value) {
//                 updateFields.push(`${key}=?`);
//                 updateParams.push(value);
//             }
//         }

//         // If there are no fields to update, return current data
//         if (updateFields.length === 0) {
//             return currentProvider;
//         }

//         // Add providerId to updateParams
//         updateParams.push(providerId);
...
//         // Return updated skill provider data
//         const updatedProvider = { ...currentProvider, ...updatedFields };
